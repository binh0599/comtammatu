...
import { Badge, Button, Popover, PopoverContent, PopoverTrigger, ScrollArea } from "@comtammatu/ui";
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="relative flex min-h-[56px] flex-1 flex-col items-center justify-center gap-1 text-xs text-muted-foreground"
